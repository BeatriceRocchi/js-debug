...
/*
1. Dato un elenco di indirizzi a cui l'accesso è consentito, la funzione controlla se l'indirizzo inserito dall'utente tramite prompt è incluso e quindi ha accesso o meno
2. Sì, sulla base di come sono stati assegnati i valori a grantAccess, nel secondo if occorre controllare se grantAccess è uguale a 'true', non solo a true senza virgolette. Oppure si potevano correggere i valori booleani assegnati a grantAccess.
3. No
*/
...
/*
1. Dato un elenco di indirizzi a cui l'accesso è consentito, la funzione controlla se l'indirizzo inserito dall'utente tramite prompt è incluso e quindi ha accesso o meno. In più fa controllo anche su lunghezza minima della email
2. Sì, la parentesi graffa della funzione non è mai stata chiusa. In più stiamo portando dietro errore sui booleani
3. No
*/